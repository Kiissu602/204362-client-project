export const passwordRule = [
  (v) =>
    ...
    'ต้องเป็นตัวอักษรภาษาอังกฤษ และตัวเลขและความยาวอยู่ในช่วง 8 - 16 หลัก',
]
...
export const ISBNRule = [(v) => /[0-9]{13}/.test(v) || 'ตัวเลข 0-9 13 หลักจ๊ะ']
...
export const NameMemberRule = [
  (v) => !!v || 'กรุณากรอกด้วยจ๊ะ',
  (v) =>
    /(^([a-zA-Z ])*$)|(^([\u0E00-\u0E7F ])*$)/.test(v) || 'รูปแบบบ่ถูกเด้อจ้า',
]
